...
* `CompareFiles`  -  Perform a file comparison using the _Compare_ plugin. To use this feature you should read [my comment](https://notepad-plus-plus.org/community/topic/16056/how-to-get-an-external-diff-viewer-with-n-and-the-last-compare-plugin-v2-0-0-0/2) in the Notepad++ community forum.
