...
:: Basic configuration
::------------------------------------------------------------------------------
set "DestFolder=C:\Program Files (x86)\UpdateExplorerIcons"
set "FilesToCopy="UpdateExplorerIcons.ico";"UpdateExplorerIcons.cmd""
set "RegFileToExecute=UpdateExplorerIcons.reg"
